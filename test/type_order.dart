var types = {
  ...
  'update_email': [String, List, bool, String, String, String, String, String],
  'create_certificate': [String, String, String, String],
  'delete_certificate': [String],
  'list_certificates': [],
  'update_certificate': [String, String, String, String],
  'create_domain': [String, List],
  'delete_domain': [String, List],
  'list_domains': [],
  'create_website': [String, String, bool, List, String, List],
  'delete_website': [String, String, bool],
  'list_bandwidth_usage': [],
  'list_websites': [],
  'update_website': [String, String, bool, List, String, List],
